...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\draw[->] (5.7, 3.25) to (6.4, 3.25);
		\draw[->] (5.7, 2.25) to (6.4, 2.25);
		\draw[->] (5.7, 1.25) to (6.4, 1.25);
		...
		\draw[fill=yellow] (6.5, 2) rectangle (7.1, 2.5);
		\draw[fill=blue]   (7.5, 2) rectangle (7.8, 2.5);
		\draw[fill=blue]   (8,   2) rectangle (8.2, 2.5);
		\draw[fill=yellow] (8.4, 2) rectangle (8.5, 2.5);
		...
		\draw[->] (10.2, 3.25) to (11, 3.25);
		\draw[->] (10.2, 2.25) to (11, 2.25);
		\draw[->] (10.2, 1.25) to (11, 1.25);
